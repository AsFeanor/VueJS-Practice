      ...
      <v-list dense>
        <v-row class="ma-2 mb-3">
          ...
          <v-toolbar-title class="align-center">
            <span class="title">Ege Test</span>
          </v-toolbar-title>
        </v-row>
          ...
          <v-card>
            <v-list>
              <v-list-item>
                ...
                <v-list-item-content>
                  <v-list-item-title>ALTUG EGE SARİ</v-list-item-title>
                  <v-list-item-subtitle>Deneme</v-list-item-subtitle>
                </v-list-item-content>
              </v-list-item>
            </v-list>
            <v-divider />
            ...
            <v-card-actions>
              <v-spacer />
              <v-btn color="primary" text @click="menu = false">Exit</v-btn>
            </v-card-actions>
          </v-card>
        </v-menu>
      </div>
...
export default {
  ...
  data: () => ({
    items:[
      ...
      {icon:"mdi-youtube-subscription",text:"Subscription"},
